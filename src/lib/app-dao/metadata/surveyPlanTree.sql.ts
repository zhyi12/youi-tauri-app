...
const TABLE_NAME = 'stats_survey_plan_tree';

export const PROPERTIES = ['id','pid','num','text','object_name','object_id','create_time','update_time','creator','modified_by'];
 ...
 *
 */
export const SQL_FIND_BY_METADATA = `${SQL_SELECT} where object_name=$1 and object_id=$2 limit 1`;
