...
const TABLE_NAME = 'youi_dmp_dashboard_group';

export const PROPERTIES = ['id','pid','num','text','full_text','create_time','update_time','creator','modified_by'];
