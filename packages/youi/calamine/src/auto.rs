...
use crate::{open_workbook, open_workbook_from_rs, DataType, Metadata, Ods, Range, Reader, Xls, Xlsb, Xlsx, Formula};
use std::borrow::Cow;
use std::fs::File;
    ...
    RS: std::io::Read + std::io::Seek,
{
    ...
    fn worksheet_formula(&mut self, name: &str) -> Result<Range<Formula>, Self::Error> {
        match *self {
